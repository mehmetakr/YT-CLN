      ...
      {categories.map((item, i) => (
        <div key={i}>
          <div
            ...
            }  flex items-center  text-black gap-2 py-4 px-2 md:px-3 text-md md:text-lg cursor-pointer rounded-md transition duration-300 hover:bg-[#cc5f5f] hover:text-white `}
          >
